  ...
  return (
    <div className="browse-container">
      ...
      {showModal && selectedNote && (
        <div id="note-details-overlay" onClick={(e) => {
          if (e.target.id === "note-details-overlay") setShowModal(false);
        }}>
          <div id="note-details-modal">
            <button id="note-details-close-btn" onClick={() => setShowModal(false)}>×</button>
            <h3 className="overlay-username">{selectedNote.uploader?.username}</h3>
            ...
            <div id="modal-content-row">
              ...
              <div id="svdu">
                <div id="about-notes">
                  ...
                  <p><strong>Views:</strong> {selectedNote.views}</p>
                  <p><strong>Downloads:</strong> {selectedNote.downloads}</p>
                  <p><strong>Uploader:</strong> {selectedNote.uploader?.username}</p>
                </div>
                <button id="buy" onClick={() => handleDownload(selectedNote)}>Download</button>
