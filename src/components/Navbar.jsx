      ...
      <div id="nav-container">
        <div id="nav-bar-wrap">
          ...
          <div id="nav-links">
            ...
            <button id="nav-btn" onClick={onMyNotesClick}>
              My Notes
            </button>
            <button id="nav-btn" onClick={onUploadClick}>
              Upload
            </button>
            <NavLink to="/browse">
              <button id="nav-btn">Browse</button>
            </NavLink>
          </div>
          ...
          <div id="avatar-menu-mobile">
            ...
            {dropdownOpen && (
              <div id="avatar-dropdown-mobile">
                ...
                <NavLink to="/browse" onClick={() => setDropdownOpen(false)}>
                  Browse
                </NavLink>
                <NavLink
